    ...
    <div class="row">
      <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/pupil/create') }}" class="btn btn-success btn-sm" title="Add New Team">
                            ...
                            <table class="table">
                                ...
                                @foreach($team as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/pupil/' . $item->id) }}" title="View Team"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/pupil/' . $item->id . '/edit') }}" title="Edit Team"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
